	...
	var Simon = function() {
		...
		this.evaluate = function () { // how did the user do?
 		...
 		this.fail = function () { // failure
 			if( SCORE >= 20 ) window.location = "https://your-server-url.here:55864/cgi-bin/game.py?s=Submit&q=14&a=878d40e4ed4cc40abed5bc65589cf0837d38de549ccee2814a5d20c61530727c302e7500e77be9f88a90fa6ee9ebbab0";
